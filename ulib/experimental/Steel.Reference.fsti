...
val pts_to_framon (#a:Type u#0) (r:ref a) (p:perm) : Lemma (is_frame_monotonic #a (fun v -> pts_to r p v))

val pts_to_witinv (#a:Type u#0) (r:ref a) (p:perm) : Lemma (witness_invariant #a (fun v -> pts_to r p v))
