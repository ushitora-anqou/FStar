                   ...
                   (FStar_Util.smap_fold dg
                      (fun filename  ->
                         fun dep_node  ->
                           fun uu____5520  ->
                             let uu____5522 =
                               let uu___988_5523 = dep_node  in
                               let uu____5524 = widen_one dep_node.edges  in
                   ...
                   | White  ->
                       ((let uu____5763 =
                        ...
                        deps_add_dep dep_graph1 filename
                          (let uu___1010_5780 = dep_node  in
                           { edges = (uu___1010_5780.edges); color = Gray });
                        (let uu____5781 =
                           let uu____5792 =
                         ...
                         | (all_friends1,all_files1) ->
                             (deps_add_dep dep_graph1 filename
                                (let uu___1016_5828 = dep_node  in
                                 {
                                   edges = (uu___1016_5828.edges);
                                   color = Black
                                 });
                              (let uu____5830 =
                                 FStar_Options.debug_at_level_no_module
  ...
  fun all_cmd_line_files  ->
    fun get_parsing_data_from_cache  ->
      ...
      let rec discover_one file_name =
        let uu____6363 =
          let uu____6365 = deps_try_find dep_graph file_name  in
        ...
        then
          let uu____6371 =
            let uu____6387 =
              ...
              FStar_Util.smap_try_find uu____6401 file_name  in
          ...
          | (parsing_data,(deps,mo_roots,needs_interface_inlining)) ->
              (if needs_interface_inlining
               ...
               (let deps1 =
                ...
                let dep_node =
                  let uu____6633 = FStar_List.unique deps1  in
  ...
  fun deps  ->
    ...
    FStar_All.pipe_right keys
      (FStar_List.iter
         (fun f  ->
            let dep_node =
              let uu____7132 = deps_try_find deps1 f  in
...
let (print_raw : deps -> unit) =
  fun deps  ->
    let uu____7161 = deps.dep_graph  in
...
let (print_full : deps -> unit) =
  fun deps  ->
        ...
        | lc_module_name::modules_to_extract ->
            let visit_file file_opt =
              ...
              | FStar_Pervasives_Native.Some file_name ->
                  let uu____7406 = deps_try_find deps.dep_graph file_name  in
            ...
            ((let uu____7422 = should_visit lc_module_name  in
              ...
              then
                ...
                ((let uu____7430 = implementation_of deps lc_module_name  in
                  visit_file uu____7430);
                 (let uu____7435 = interface_of deps lc_module_name  in
    ...
    let pr str =
      ...
      FStar_All.pipe_left (fun a1  -> ()) uu____7488  in
    ...
    let output_file ext fst_file =
      let ml_base_name =
        let uu____7541 =
          let uu____7543 =
            let uu____7547 = FStar_Util.basename fst_file  in
            check_and_strip_suffix uu____7547  in
          FStar_Option.get uu____7543  in
        FStar_Util.replace_chars uu____7541 46 "_"  in
      let uu____7552 = FStar_String.op_Hat ml_base_name ext  in
      FStar_Options.prepend_output_dir uu____7552  in
    let norm_path s = FStar_Util.replace_chars s 92 "/"  in
    let output_ml_file f =
      let uu____7574 = output_file ".ml" f  in norm_path uu____7574  in
    let output_krml_file f =
      let uu____7586 = output_file ".krml" f  in norm_path uu____7586  in
    let output_cmx_file f =
      let uu____7598 = output_file ".cmx" f  in norm_path uu____7598  in
    let cache_file f =
      let uu____7610 = cache_file_name f  in norm_path uu____7610  in
    let uu____7612 =
          ...
          FStar_All.pipe_right keys
            (FStar_List.fold_left
               (fun all_checked_files  ->
                  fun file_name  ->
                    let process_one_key uu____7654 =
                      let dep_node =
                        let uu____7656 =
                      ...
                      let iface_deps =
                        ...
                        then FStar_Pervasives_Native.None
                          ...
                          (let uu____7677 =
                             let uu____7681 = lowercase_module_name file_name
                                in
                             interface_of deps uu____7681  in
                      ...
                      let all_checked_files1 =
                        let uu____7779 =
                          let uu____7781 =
                            let uu____7783 = module_name_of_file file_name
                               in
                            FStar_Options.should_be_already_cached uu____7783
                             in
                          Prims.op_Negation uu____7781  in
                        if uu____7779
                        then
                      ...
                      let uu____7793 =
                        let uu____7802 = FStar_Options.cmi ()  in
                        if uu____7802
                        then
                          profile
                            (fun uu____7823  ->
                               let uu____7824 = dep_graph_copy dep_graph  in
                               topological_dependences_of'
                                 deps.file_system_map uu____7824
                      ...
                      | (all_fst_files_dep,widened1) ->
                          ...
                          let all_checked_fst_dep_files_string =
                            FStar_String.concat " \\\n\t"
                             ...
                             in
                          ((let uu____7909 = is_implementation file_name  in
                            if uu____7909
                            then
                              ((let uu____7913 =
                                ...
                                if uu____7913
                                then
                                  ((let uu____7917 = output_ml_file file_name
                                       in
                                  ...
                                  ((let uu____7924 = output_ml_file file_name
                                       in
                                    print_entry uu____7924 cache_file_name1
                                      "");
                                   (let uu____7927 =
                                      output_krml_file file_name  in
                                    print_entry uu____7927 cache_file_name1
                                      "")));
                               (let cmx_files =
                                ...
                                let uu____7968 =
                                  ...
                                  FStar_Options.should_extract uu____7970  in
                                if uu____7968
                                then
                                  let cmx_files1 =
                                    FStar_String.concat "\\\n\t" cmx_files
                                     in
                                  let uu____7976 = output_cmx_file file_name
                                     in
                                  let uu____7978 = output_ml_file file_name
                                     in
                                  print_entry uu____7976 uu____7978
                                    cmx_files1
                                else ()))
                            else
                              (let uu____7984 =
                               ...
                               then
                                 ...
                                 (if uu____7993
                                  then
                                    let uu____7997 =
                                      output_krml_file file_name  in
                                    print_entry uu____7997 cache_file_name1
                                      all_checked_fst_dep_files_string
                                  else
                                    (let uu____8001 =
                                       output_krml_file file_name  in
                                     print_entry uu____8001 cache_file_name1
                                       ""))
                               else ()));
                           all_checked_files1)
                       in
          ...
          FStar_All.pipe_right all_fst_files
            (FStar_List.iter
               (fun fst_file  ->
                  ...
                  let uu____8078 = FStar_Options.should_extract mname  in
                  if uu____8078
                  then
                    let uu____8081 = output_ml_file fst_file  in
                    FStar_Util.smap_add ml_file_map mname uu____8081
                  else ()));
        ...
        let all_krml_files =
          ...
          FStar_All.pipe_right keys
            (FStar_List.iter
               (fun fst_file  ->
                  let mname = lowercase_module_name fst_file  in
                  let uu____8108 = output_krml_file fst_file  in
                  FStar_Util.smap_add krml_file_map mname uu____8108));
...
let (print : deps -> unit) =
  fun deps  ->
    let uu____8158 = FStar_Options.dep ()  in
    match uu____8158 with
    | FStar_Pervasives_Native.Some "make" -> print_make deps
    | FStar_Pervasives_Native.Some "full" ->
        profile (fun uu____8167  -> print_full deps)
                 ...
                 let uu____8257 =
                   let uu____8259 =
                     FStar_Util.format3 "%s -> (%s, %s)" k
                      ...
                      in
                   FStar_String.op_Hat "; " uu____8259  in
                 FStar_String.op_Hat s uu____8257) ""
  
let (module_has_interface : deps -> FStar_Ident.lident -> Prims.bool) =
  fun deps  ->
    fun module_name  ->
      let uu____8280 =
        let uu____8282 = FStar_Ident.string_of_lid module_name  in
        FStar_String.lowercase uu____8282  in
      has_interface deps.file_system_map uu____8280
  
let (deps_has_implementation : deps -> FStar_Ident.lident -> Prims.bool) =
  fun deps  ->
    fun module_name  ->
      let m =
        let uu____8298 = FStar_Ident.string_of_lid module_name  in
        FStar_String.lowercase uu____8298  in
      FStar_All.pipe_right deps.all_files
        (FStar_Util.for_some
           (fun f  ->
              (is_implementation f) &&
                (let uu____8309 =
                   let uu____8311 = module_name_of_file f  in
