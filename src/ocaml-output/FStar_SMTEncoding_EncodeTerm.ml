    ...
    fun env  ->
      ...
      (match t1.FStar_Syntax_Syntax.n with
                         ...
                         (FStar_Const.Const_reify ),uu____6985) ->
                          ...
                          ((let uu____7017 =
                           ...
                           (let e =
                              ...
                              let uu____7029 = FStar_List.tl args_e1  in
                              FStar_Syntax_Syntax.mk_Tm_app uu____7028
                                uu____7029 t0.FStar_Syntax_Syntax.pos
                               in
                            encode_term e env))
                      | (FStar_Syntax_Syntax.Tm_constant
                         (FStar_Const.Const_reflect
                         uu____7038),(arg,uu____7040)::[]) ->
                          encode_term arg env
                      | uu____7075 ->
                          let uu____7090 = encode_args args_e1 env  in
                          (match uu____7090 with
                           | (args,decls) ->
                               let encode_partial_app ht_opt =
                                 let uu____7159 = encode_term head2 env  in
                               ...
                               let head_type =
                                 ...
                                 | FStar_Syntax_Syntax.Tm_uinst
                                     ({
                                        FStar_Syntax_Syntax.n =
                                          FStar_Syntax_Syntax.Tm_name x;
                                        FStar_Syntax_Syntax.pos = uu____7902;
                                        FStar_Syntax_Syntax.vars = uu____7903;_},uu____7904)
                                     ->
                                     FStar_Pervasives_Native.Some
                                 ...
                                 | FStar_Syntax_Syntax.Tm_uinst
                                     ({
                                        FStar_Syntax_Syntax.n =
                                          FStar_Syntax_Syntax.Tm_fvar fv;
                                        FStar_Syntax_Syntax.pos = uu____7911;
                                        FStar_Syntax_Syntax.vars = uu____7912;_},uu____7913)
                                     ->
                                     let uu____7918 =
                                       let uu____7919 =
                                         let uu____7924 =
                                 ...
                                 | FStar_Syntax_Syntax.Tm_ascribed
                                     (uu____7989,(FStar_Util.Inl
                                                  t2,uu____7991),uu____7992)
                                     -> FStar_Pervasives_Native.Some t2
                                 | FStar_Syntax_Syntax.Tm_ascribed
                                     (uu____8039,(FStar_Util.Inr
                                                  c,uu____8041),uu____8042)
                                     ->
                                     FStar_Pervasives_Native.Some
       ...
       | FStar_Syntax_Syntax.Tm_abs (bs,body,lopt) ->
           let uu____8401 = FStar_Syntax_Subst.open_term' bs body  in
           (match uu____8401 with
            | (bs1,body1,opening) ->
                let fallback uu____8424 =
                  let f =
                    FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
                ...
                let is_impure rc =
                  let uu____8447 =
                    FStar_TypeChecker_Util.is_pure_or_ghost_effect
                     ...
                     in
                  FStar_All.pipe_right uu____8447 Prims.op_Negation  in
                let codomain_eff rc =
                  let res_typ =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        let uu____8462 =
                          ...
                          FStar_TypeChecker_Util.new_implicit_var
                            "SMTEncoding codomain" uu____8475
                            env.FStar_SMTEncoding_Env.tcenv
                            FStar_Syntax_Util.ktype0
                           in
                        (match uu____8462 with
                         | (t2,uu____8478,uu____8479) -> t2)
                  ...
                  if uu____8497
                  then
                    let uu____8502 = FStar_Syntax_Syntax.mk_Total res_typ  in
                    ...
                    (let uu____8505 =
                     ...
                     if uu____8505
                     then
                       let uu____8510 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                 ...
                 | FStar_Pervasives_Native.Some rc ->
                     ...
                     then fallback ()
                       ...
                       (let uu____8543 =
                        ...
                        | (vars,guards,envbody,decls,uu____8568) ->
                            let body2 =
                              let uu____8582 =
                                FStar_SMTEncoding_Util.is_smt_reifiable_rc
                                  env.FStar_SMTEncoding_Env.tcenv rc
                            ...
                            let uu____8587 = encode_term body2 envbody  in
                             ...
                             | (body3,decls') ->
                                 let is_pure =
                                   FStar_Syntax_Util.is_pure_effect
                                    ...
                                    in
                                 let uu____8600 =
                                   let uu____8609 = codomain_eff rc  in
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____8628 = encode_term tfun env
                                          in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((false
             ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                FStar_Syntax_Syntax.lbunivs = uu____8989;
                FStar_Syntax_Syntax.lbtyp = t11;
                FStar_Syntax_Syntax.lbeff = uu____8991;
                FStar_Syntax_Syntax.lbdef = e1;
                FStar_Syntax_Syntax.lbattrs = uu____8993;
                FStar_Syntax_Syntax.lbpos = uu____8994;_}::[]),e2)
           -> encode_let x t11 e1 e2 env encode_term
       | FStar_Syntax_Syntax.Tm_let
           ((false ,uu____9021::uu____9022),uu____9023) ->
           failwith "Impossible: non-recursive let with multiple bindings"
       | FStar_Syntax_Syntax.Tm_let ((uu____9046,lbs),uu____9048) ->
           let names1 =
             FStar_All.pipe_right lbs
               (FStar_List.map
                  (fun lb  ->
                     let uu____9101 = lb  in
                     match uu____9101 with
                     | { FStar_Syntax_Syntax.lbname = lbname;
                         FStar_Syntax_Syntax.lbunivs = uu____9108;
                         FStar_Syntax_Syntax.lbtyp = uu____9109;
                         FStar_Syntax_Syntax.lbeff = uu____9110;
                         FStar_Syntax_Syntax.lbdef = uu____9111;
                         FStar_Syntax_Syntax.lbattrs = uu____9112;
                         FStar_Syntax_Syntax.lbpos = uu____9113;_} ->
                         let x = FStar_Util.left lbname  in
                         let uu____9129 =
                           FStar_Ident.text_of_id
                             x.FStar_Syntax_Syntax.ppname
                            in
                         let uu____9131 = FStar_Syntax_Syntax.range_of_bv x
                            in
                         (uu____9129, uu____9131)))
              in
            ...
            fun encode_body  ->
              ...
              | (ee1,decls1) ->
                  ...
                  (match uu____9219 with
                   | (xs,e21) ->
                       let uu____9244 = FStar_List.hd xs  in
                       (match uu____9244 with
                        | (x1,uu____9262) ->
                            let env' =
                              FStar_SMTEncoding_Env.push_term_var env x1 ee1
                               in
                            let uu____9268 = encode_body e21 env'  in
              ...
              let uu____9306 =
                let uu____9307 =
                  FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown
                    FStar_Range.dummyRange
                   in
                FStar_Syntax_Syntax.null_bv uu____9307  in
              FStar_SMTEncoding_Env.gen_term_var env uu____9306  in
            match uu____9298 with
            | (scrsym,scr',env1) ->
                let uu____9317 = encode_term e env1  in
                (match uu____9317 with
                 | (scr,decls) ->
                     let uu____9328 =
                       let encode_branch b uu____9357 =
                         ...
                         | (else_case,decls1) ->
                             ...
                             (match uu____9376 with
                              | (p,w,br) ->
                                  let uu____9402 = encode_pat env1 p  in
                            ...
                            let uu____9543 =
                              let uu____9554 =
                                let uu____9561 =
                                  ...
                                  (uu____9566, scr)  in
                                [uu____9561]  in
                              (uu____9554, match_tm)  in
                            FStar_SMTEncoding_Term.mkLet' uu____9543
                              FStar_Range.dummyRange
                             in
                          (uu____9542, decls1)))
  ...
  fun env  ->
    fun pat  ->
      (let uu____9589 =
       ...
       if uu____9589
       then
         let uu____9592 = FStar_Syntax_Print.pat_to_string pat  in
         FStar_Util.print1 "Encoding pattern %s\n" uu____9592
       else ());
      (let uu____9597 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
           ...
           (match uu____9614 with
            | (env1,vars1) ->
                let rec mk_guard pat1 scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_var uu____9782 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_wild uu____9783 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_dot_term uu____9784 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_constant c ->
                      let uu____9792 = encode_const c env1  in
                ...
                let rec mk_projections pat1 scrutinee =
                  match pat1.FStar_Syntax_Syntax.v with
                  | FStar_Syntax_Syntax.Pat_dot_term (x,uu____9929) ->
                      [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_var x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_wild x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_constant uu____9960 -> []
                  | FStar_Syntax_Syntax.Pat_cons (f,args) ->
                      let uu____9985 =
                        FStar_All.pipe_right args
                          (FStar_List.mapi
                                  ...
                                  | (arg,uu____10047) ->
                                      ...
                                      let uu____10056 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____10056))
                         in
                      FStar_All.pipe_right uu____9985 FStar_List.flatten
                   in
                let pat_term1 uu____10087 = encode_term pat_term env1  in
                let pattern =
                  {
                    pat_vars = vars1;
                    pat_term = pat_term1;
          ...
          (FStar_List.fold_left
             (fun uu____10145  ->
                fun uu____10146  ->
                  ...
                  | ((tms,decls),(t,uu____10186)) ->
                      let uu____10213 = encode_term t env  in
                      (match uu____10213 with
                       | (t1,decls') ->
                           ((t1 :: tms), (FStar_List.append decls decls'))))
             ([], []))
         in
      match uu____10097 with | (l1,decls) -> ((FStar_List.rev l1), decls)
  ...
  fun t  ->
    fun env  ->
      let universe_of_binders binders =
        FStar_List.map (fun uu____10291  -> FStar_Syntax_Syntax.U_zero)
          binders
         in
      let quant = FStar_Syntax_Util.smt_lemma_as_forall t universe_of_binders
         in
      let env1 =
        let uu___1409_10300 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1409_10300.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1409_10300.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1409_10300.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1409_10300.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1409_10300.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1409_10300.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1409_10300.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1409_10300.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1409_10300.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1409_10300.FStar_SMTEncoding_Env.global_cache)
        }  in
...
and (encode_smt_patterns :
  ...
  fun pats_l  ->
    fun env  ->
      let env1 =
        let uu___1414_10317 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1414_10317.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1414_10317.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1414_10317.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1414_10317.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1414_10317.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1414_10317.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1414_10317.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1414_10317.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1414_10317.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1414_10317.FStar_SMTEncoding_Env.global_cache)
        }  in
      let encode_smt_pattern t =
        let uu____10333 = FStar_Syntax_Util.head_and_args t  in
        match uu____10333 with
        | (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____10396::(x,uu____10398)::(t1,uu____10400)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____10467 = encode_term x env1  in
                 (match uu____10467 with
                  | (x1,decls) ->
                      let uu____10478 = encode_term t1 env1  in
                      (match uu____10478 with
                       | (t2,decls') ->
                           let uu____10489 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t2  in
                           (uu____10489, (FStar_List.append decls decls'))))
             | uu____10490 -> encode_term t env1)
         in
                   ...
                   FStar_List.fold_right
                     (fun uu____10613  ->
                        fun uu____10614  ->
                          ...
                          | ((p,uu____10656),(pats1,decls1)) ->
                              let uu____10691 = encode_smt_pattern p  in
  ...
  fun phi  ->
    fun env  ->
      let debug1 phi1 =
        ...
        if uu____10793
        then
          let uu____10798 = FStar_Syntax_Print.tag_of_term phi1  in
      ...
      let enc f r l =
        ...
        | (decls,args) ->
            let uu____10905 =
              let uu___1478_10906 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1478_10906.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1478_10906.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____10905, decls)
         in
      let const_op f r uu____10941 =
        let uu____10954 = f r  in (uu____10954, [])  in
      let un_op f l =
        let uu____10977 = FStar_List.hd l  in
        FStar_All.pipe_left f uu____10977  in
      let bin_op f uu___2_10997 =
        match uu___2_10997 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
          ...
          FStar_Util.fold_map
            (fun decls  ->
               fun uu____11074  ->
                 ...
                 | (t,uu____11090) ->
                     let uu____11095 = encode_formula t env  in
        ...
        | (decls,phis) ->
            let uu____11124 =
              let uu___1508_11125 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1508_11125.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1508_11125.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____11124, decls)
         in
          ...
          FStar_List.filter
            (fun uu____11188  ->
               ...
               | (a,q) ->
                   (match q with
                    | FStar_Pervasives_Native.Some
                        (FStar_Syntax_Syntax.Implicit uu____11209) -> false
                    | uu____11212 -> true)) args
           in
        ...
        then
          let uu____11231 =
            FStar_Util.format1
             ...
             in
          failwith uu____11231
        else
          (let uu____11248 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____11248 r rf)
         in
      let eq3_op r args =
          ...
          let uu____11316 =
            enc
              (fun terms  ->
                 ...
                 | t0::t1::v0::v1::[] ->
                     let uu____11348 =
                       let uu____11353 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____11354 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____11353, uu____11354)  in
                     FStar_SMTEncoding_Util.mkAnd uu____11348
                 | uu____11355 -> failwith "Impossible")
             in
          uu____11316 r args
        else
          (let uu____11361 =
          ...
          let uu____11423 =
            enc
              (fun terms  ->
                 ...
                 | t0::v0::t1::v1::[] ->
                     let uu____11455 =
                       let uu____11460 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____11461 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____11460, uu____11461)  in
                     FStar_SMTEncoding_Util.mkAnd uu____11455
                 | uu____11462 -> failwith "Impossible")
             in
          uu____11423 r args
        else
          (let uu____11468 =
             FStar_Util.format1
               ...
               (Prims.string_of_int n1)
              in
           failwith uu____11468)
         in
      let mk_imp1 r uu___3_11497 =
        match uu___3_11497 with
        | (lhs,uu____11503)::(rhs,uu____11505)::[] ->
            let uu____11546 = encode_formula rhs env  in
            (match uu____11546 with
             | (l1,decls1) ->
                 (match l1.FStar_SMTEncoding_Term.tm with
                  | FStar_SMTEncoding_Term.App
                      (FStar_SMTEncoding_Term.TrueOp ,uu____11561) ->
                      (l1, decls1)
                  | uu____11566 ->
                      let uu____11567 = encode_formula lhs env  in
                      (match uu____11567 with
                       | (l2,decls2) ->
                           let uu____11578 =
                             FStar_SMTEncoding_Term.mkImp (l2, l1) r  in
                           (uu____11578, (FStar_List.append decls1 decls2)))))
        | uu____11579 -> failwith "impossible"  in
      let mk_ite r uu___4_11607 =
        match uu___4_11607 with
        | (guard,uu____11613)::(_then,uu____11615)::(_else,uu____11617)::[]
            ->
            let uu____11674 = encode_formula guard env  in
            (match uu____11674 with
             | (g,decls1) ->
                 let uu____11685 = encode_formula _then env  in
                 (match uu____11685 with
                  | (t,decls2) ->
                      let uu____11696 = encode_formula _else env  in
        ...
        | uu____11708 -> failwith "impossible"  in
      let unboxInt_l f l =
        let uu____11738 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l
           in
        f uu____11738  in
      let connectives =
        let uu____11768 =
          let uu____11793 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Parser_Const.and_lid, uu____11793)  in
        let uu____11836 =
          let uu____11863 =
            let uu____11888 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
            (FStar_Parser_Const.or_lid, uu____11888)  in
          let uu____11931 =
            let uu____11958 =
              let uu____11985 =
                let uu____12010 =
                  enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)  in
                (FStar_Parser_Const.iff_lid, uu____12010)  in
              let uu____12053 =
                let uu____12080 =
                  let uu____12107 =
                    let uu____12132 =
                      enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot)  in
                    (FStar_Parser_Const.not_lid, uu____12132)  in
                  [uu____12107;
                  ...
                  (FStar_Parser_Const.false_lid,
                   ...
                   in
                (FStar_Parser_Const.ite_lid, mk_ite) :: uu____12080  in
              uu____11985 :: uu____12053  in
            (FStar_Parser_Const.imp_lid, mk_imp1) :: uu____11958  in
          uu____11863 :: uu____11931  in
        uu____11768 :: uu____11836  in
      let rec fallback phi1 =
        match phi1.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_meta
            (phi',FStar_Syntax_Syntax.Meta_labeled (msg,r,b)) ->
            let uu____12677 = encode_formula phi' env  in
             ...
             | (phi2,decls) ->
                 let uu____12688 =
                   FStar_SMTEncoding_Term.mk
                    ...
                    in
                 (uu____12688, decls))
        | FStar_Syntax_Syntax.Tm_meta uu____12690 ->
            let uu____12697 = FStar_Syntax_Util.unmeta phi1  in
            encode_formula uu____12697 env
        | FStar_Syntax_Syntax.Tm_match (e,pats) ->
            let uu____12736 =
              encode_match e pats FStar_SMTEncoding_Util.mkFalse env
                encode_formula
               in
            (match uu____12736 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_let
            ((false
              ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                 ...
                 FStar_Syntax_Syntax.lbpos = uu____12753;_}::[]),e2)
            ->
            let uu____12780 = encode_let x t1 e1 e2 env encode_formula  in
            (match uu____12780 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_app (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____12833::(x,uu____12835)::(t,uu____12837)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____12904 = encode_term x env  in
                 (match uu____12904 with
                  | (x1,decls) ->
                      let uu____12915 = encode_term t env  in
                      (match uu____12915 with
                       | (t1,decls') ->
                           let uu____12926 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t1  in
                           (uu____12926, (FStar_List.append decls decls'))))
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(r,uu____12929)::(msg,uu____12931)::(phi2,uu____12933)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____13000 =
                   let uu____13005 =
                     let uu____13006 = FStar_Syntax_Subst.compress r  in
                     uu____13006.FStar_Syntax_Syntax.n  in
                   let uu____13009 =
                     let uu____13010 = FStar_Syntax_Subst.compress msg  in
                     uu____13010.FStar_Syntax_Syntax.n  in
                   (uu____13005, uu____13009)  in
                 (match uu____13000 with
                  | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_range
                     r1),FStar_Syntax_Syntax.Tm_constant
                     (FStar_Const.Const_string (s,uu____13019))) ->
                      let phi3 =
                        FStar_Syntax_Syntax.mk
                         ...
                         in
                      fallback phi3
                  | uu____13030 -> fallback phi2)
             | (FStar_Syntax_Syntax.Tm_fvar fv,(t,uu____13037)::[]) when
                 (FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         let uu____13109 =
                           ...
                           let uu____13112 =
                             FStar_Range.use_range
                              ...
                              in
                           FStar_Range.rng_included uu____13111 uu____13112
                            in
                         if uu____13109
                         then tt
                         else
                           (let uu___1696_13116 = tt  in
                            {
                              FStar_SMTEncoding_Term.tm =
                                (uu___1696_13116.FStar_SMTEncoding_Term.tm);
                              FStar_SMTEncoding_Term.freevars =
                                (uu___1696_13116.FStar_SMTEncoding_Term.freevars);
                              FStar_SMTEncoding_Term.rng =
                                (phi1.FStar_Syntax_Syntax.pos)
                            })
                          in
                       let uu____13117 = FStar_SMTEncoding_Term.mk_Valid tt1
                          in
                       (uu____13117, decls)
                    in
                 let uu____13118 = head_redex env head2  in
                 if uu____13118
                 then
                   let uu____13125 = maybe_whnf env head2  in
        ...
        | uu____13135 ->
            let uu____13136 = encode_term phi1 env  in
             ...
             | (tt,decls) ->
                 let tt1 =
                   let uu____13148 =
                     ...
                     FStar_Range.rng_included uu____13150 uu____13151  in
                   if uu____13148
                   then tt
                   else
                     (let uu___1708_13155 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___1708_13155.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___1708_13155.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                 let uu____13156 = FStar_SMTEncoding_Term.mk_Valid tt1  in
                 (uu____13156, decls))
         in
      let encode_q_body env1 bs ps body =
        let uu____13200 = encode_binders FStar_Pervasives_Native.None bs env1
           in
        match uu____13200 with
        | (vars,guards,env2,decls,uu____13239) ->
            let uu____13252 = encode_smt_patterns ps env2  in
            (match uu____13252 with
             | (pats,decls') ->
                 let uu____13289 = encode_formula body env2  in
                  ...
                  | (body1,decls'') ->
                      let guards1 =
                        ...
                        | ({
                             ...
                             FStar_SMTEncoding_Term.freevars = uu____13321;
                             FStar_SMTEncoding_Term.rng = uu____13322;_}::[])::[]
                            when
                            let uu____13342 =
                              FStar_Ident.text_of_lid
                               ...
                               in
                            uu____13342 = gf -> []
                        | uu____13345 -> guards  in
                      let uu____13350 =
                        FStar_SMTEncoding_Util.mk_and_l guards1  in
                      (vars, pats, uu____13350, body1,
                        (FStar_List.append decls
                           (FStar_List.append decls' decls'')))))
         in
      debug1 phi;
      (let phi1 = FStar_Syntax_Util.unascribe phi  in
       let uu____13361 = FStar_Syntax_Util.destruct_typ_as_formula phi1  in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____13476  ->
                     ...
                     | (l,uu____13501) -> FStar_Ident.lid_equals op l))
              in
           (match uu____13370 with
            | FStar_Pervasives_Native.None  -> fallback phi1
            | FStar_Pervasives_Native.Some (uu____13570,f) ->
                f phi1.FStar_Syntax_Syntax.pos arms)
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
           (vars,pats,body)) ->
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____13662 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let tm =
                   let uu____13707 =
                     ...
                     (pats1, vars1, uu____13718)  in
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____13707
                    in
                 (tm, decls)))
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QEx
           ...
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____13749 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let uu____13793 =
                   let uu____13794 =
                     ...
                     (pats1, vars1, uu____13805)  in
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____13794
                    in
                 (uu____13793, decls))))
