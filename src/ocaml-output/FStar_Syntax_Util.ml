...
let (mk_field_projector_name :
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        let nm =
          let uu____5747 = FStar_Syntax_Syntax.is_null_bv x  in
          if uu____5747
          then
            let uu____5750 =
              let uu____5756 =
                let uu____5758 = FStar_Util.string_of_int i  in
                Prims.op_Hat "_" uu____5758  in
              let uu____5761 = FStar_Syntax_Syntax.range_of_bv x  in
              (uu____5756, uu____5761)  in
            FStar_Ident.mk_ident uu____5750
              ...
              let uu____5942 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___1005_5943.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____5944;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___1005_5943.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____7266 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___1132_7267.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____7268;
              FStar_Syntax_Syntax.residual_flags =
                (uu___1132_7267.FStar_Syntax_Syntax.residual_flags)
            }  in
...
let rec (term_eq_dbg :
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        let t11 = let uu____15149 = unmeta_safe t1  in canon_app uu____15149
           in
        let t21 = let uu____15155 = unmeta_safe t2  in canon_app uu____15155
           in
        let uu____15158 =
          let uu____15163 =
            let uu____15164 =
              let uu____15167 = un_uinst t11  in
              FStar_Syntax_Subst.compress uu____15167  in
            uu____15164.FStar_Syntax_Syntax.n  in
          let uu____15168 =
            let uu____15169 =
              let uu____15172 = un_uinst t21  in
              FStar_Syntax_Subst.compress uu____15172  in
            uu____15169.FStar_Syntax_Syntax.n  in
          (uu____15163, uu____15168)  in
        match uu____15158 with
        | (FStar_Syntax_Syntax.Tm_uinst uu____15174,uu____15175) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15184,FStar_Syntax_Syntax.Tm_uinst uu____15185) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_delayed uu____15194,uu____15195) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15212,FStar_Syntax_Syntax.Tm_delayed uu____15213) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_ascribed uu____15230,uu____15231) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15260,FStar_Syntax_Syntax.Tm_ascribed uu____15261) ->
            failwith "term_eq: impossible, should have been removed"
        ...
        | (FStar_Syntax_Syntax.Tm_fvar x,FStar_Syntax_Syntax.Tm_fvar y) ->
            let uu____15300 = FStar_Syntax_Syntax.fv_eq x y  in
            check "fvar" uu____15300
        | (FStar_Syntax_Syntax.Tm_constant c1,FStar_Syntax_Syntax.Tm_constant
           c2) ->
            let uu____15305 = FStar_Const.eq_const c1 c2  in
            check "const" uu____15305
        | (FStar_Syntax_Syntax.Tm_type
           uu____15308,FStar_Syntax_Syntax.Tm_type uu____15309) -> true
        | (FStar_Syntax_Syntax.Tm_abs (b1,t12,k1),FStar_Syntax_Syntax.Tm_abs
           (b2,t22,k2)) ->
            (let uu____15367 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "abs binders" uu____15367) &&
              (let uu____15377 = term_eq_dbg dbg t12 t22  in
               check "abs bodies" uu____15377)
        | (FStar_Syntax_Syntax.Tm_arrow (b1,c1),FStar_Syntax_Syntax.Tm_arrow
           (b2,c2)) ->
            (let uu____15426 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "arrow binders" uu____15426) &&
              (let uu____15436 = comp_eq_dbg dbg c1 c2  in
               check "arrow comp" uu____15436)
        | (FStar_Syntax_Syntax.Tm_refine
           (b1,t12),FStar_Syntax_Syntax.Tm_refine (b2,t22)) ->
            (let uu____15453 =
               term_eq_dbg dbg b1.FStar_Syntax_Syntax.sort
                ...
                in
             check "refine bv sort" uu____15453) &&
              (let uu____15457 = term_eq_dbg dbg t12 t22  in
               check "refine formula" uu____15457)
        | (FStar_Syntax_Syntax.Tm_app (f1,a1),FStar_Syntax_Syntax.Tm_app
           (f2,a2)) ->
            (let uu____15514 = term_eq_dbg dbg f1 f2  in
             check "app head" uu____15514) &&
              (let uu____15518 = eqlist (arg_eq_dbg dbg) a1 a2  in
               check "app args" uu____15518)
        | (FStar_Syntax_Syntax.Tm_match
           (t12,bs1),FStar_Syntax_Syntax.Tm_match (t22,bs2)) ->
            (let uu____15607 = term_eq_dbg dbg t12 t22  in
             check "match head" uu____15607) &&
              (let uu____15611 = eqlist (branch_eq_dbg dbg) bs1 bs2  in
               check "match branches" uu____15611)
        | (FStar_Syntax_Syntax.Tm_lazy uu____15628,uu____15629) ->
            let uu____15630 =
              let uu____15632 = unlazy t11  in
              term_eq_dbg dbg uu____15632 t21  in
            check "lazy_l" uu____15630
        | (uu____15634,FStar_Syntax_Syntax.Tm_lazy uu____15635) ->
            let uu____15636 =
              let uu____15638 = unlazy t21  in
              term_eq_dbg dbg t11 uu____15638  in
            check "lazy_r" uu____15636
        | (FStar_Syntax_Syntax.Tm_let
           ((b1,lbs1),t12),FStar_Syntax_Syntax.Tm_let ((b2,lbs2),t22)) ->
            ((check "let flag" (b1 = b2)) &&
               (let uu____15683 = eqlist (letbinding_eq_dbg dbg) lbs1 lbs2
                   in
                check "let lbs" uu____15683))
              &&
              (let uu____15687 = term_eq_dbg dbg t12 t22  in
               check "let body" uu____15687)
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____15691),FStar_Syntax_Syntax.Tm_uvar (u2,uu____15693)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu____15751 =
               let uu____15753 = eq_quoteinfo qi1 qi2  in uu____15753 = Equal
                in
             check "tm_quoted qi" uu____15751) &&
              (let uu____15756 = term_eq_dbg dbg qt1 qt2  in
               check "tm_quoted payload" uu____15756)
        | (FStar_Syntax_Syntax.Tm_meta (t12,m1),FStar_Syntax_Syntax.Tm_meta
           (t22,m2)) ->
            (match (m1, m2) with
             | (FStar_Syntax_Syntax.Meta_monadic
                (n1,ty1),FStar_Syntax_Syntax.Meta_monadic (n2,ty2)) ->
                 (let uu____15786 = FStar_Ident.lid_equals n1 n2  in
                  check "meta_monadic lid" uu____15786) &&
                   (let uu____15790 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic type" uu____15790)
             | (FStar_Syntax_Syntax.Meta_monadic_lift
                (s1,t13,ty1),FStar_Syntax_Syntax.Meta_monadic_lift
                (s2,t23,ty2)) ->
                 ((let uu____15809 = FStar_Ident.lid_equals s1 s2  in
                   check "meta_monadic_lift src" uu____15809) &&
                    (let uu____15813 = FStar_Ident.lid_equals t13 t23  in
                     check "meta_monadic_lift tgt" uu____15813))
                   &&
                   (let uu____15817 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic_lift type" uu____15817)
             | uu____15820 -> fail "metas")
        | (FStar_Syntax_Syntax.Tm_unknown ,uu____15826) -> fail "unk"
        | (uu____15828,FStar_Syntax_Syntax.Tm_unknown ) -> fail "unk"
        | (FStar_Syntax_Syntax.Tm_bvar uu____15830,uu____15831) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_name uu____15833,uu____15834) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_fvar uu____15836,uu____15837) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_constant uu____15839,uu____15840) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_type uu____15842,uu____15843) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_abs uu____15845,uu____15846) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_arrow uu____15866,uu____15867) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_refine uu____15883,uu____15884) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_app uu____15892,uu____15893) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_match uu____15911,uu____15912) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_let uu____15936,uu____15937) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_uvar uu____15952,uu____15953) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_meta uu____15967,uu____15968) ->
            fail "bottom"
        | (uu____15976,FStar_Syntax_Syntax.Tm_bvar uu____15977) ->
            fail "bottom"
        | (uu____15979,FStar_Syntax_Syntax.Tm_name uu____15980) ->
            fail "bottom"
        | (uu____15982,FStar_Syntax_Syntax.Tm_fvar uu____15983) ->
            fail "bottom"
        | (uu____15985,FStar_Syntax_Syntax.Tm_constant uu____15986) ->
            fail "bottom"
        | (uu____15988,FStar_Syntax_Syntax.Tm_type uu____15989) ->
            fail "bottom"
        | (uu____15991,FStar_Syntax_Syntax.Tm_abs uu____15992) ->
            fail "bottom"
        | (uu____16012,FStar_Syntax_Syntax.Tm_arrow uu____16013) ->
            fail "bottom"
        | (uu____16029,FStar_Syntax_Syntax.Tm_refine uu____16030) ->
            fail "bottom"
        | (uu____16038,FStar_Syntax_Syntax.Tm_app uu____16039) ->
            fail "bottom"
        | (uu____16057,FStar_Syntax_Syntax.Tm_match uu____16058) ->
            fail "bottom"
        | (uu____16082,FStar_Syntax_Syntax.Tm_let uu____16083) ->
            fail "bottom"
        | (uu____16098,FStar_Syntax_Syntax.Tm_uvar uu____16099) ->
            fail "bottom"
        | (uu____16113,FStar_Syntax_Syntax.Tm_meta uu____16114) ->
            fail "bottom"
    ...
    fun a1  ->
      fun a2  ->
        eqprod
          (fun t1  ->
             fun t2  ->
               let uu____16149 = term_eq_dbg dbg t1 t2  in
               check "arg tm" uu____16149)
          (fun q1  ->
             fun q2  ->
               let uu____16161 =
                 let uu____16163 = eq_aqual q1 q2  in uu____16163 = Equal  in
               check "arg qual" uu____16161) a1 a2
             ...
             fun b21  ->
               let uu____16188 =
                 term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort
                  ...
                  in
               check "binder sort" uu____16188)
          (fun q1  ->
             fun q2  ->
               let uu____16200 =
                 let uu____16202 = eq_aqual q1 q2  in uu____16202 = Equal  in
               check "binder qual" uu____16200) b1 b2
      ...
      fun c2  ->
        ...
        ((let uu____16216 =
            FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name
             ...
             in
          check "comp eff" uu____16216) &&
           (let uu____16220 =
              term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ
                c21.FStar_Syntax_Syntax.result_typ
               in
            check "comp result typ" uu____16220))
          && true
...
and (branch_eq_dbg :
  ...
  fun dbg  ->
    fun uu____16225  ->
      fun uu____16226  ->
        match (uu____16225, uu____16226) with
        | ((p1,w1,t1),(p2,w2,t2)) ->
            ((let uu____16353 = FStar_Syntax_Syntax.eq_pat p1 p2  in
              check "branch pat" uu____16353) &&
               (let uu____16357 = term_eq_dbg dbg t1 t2  in
                check "branch body" uu____16357))
              &&
              (let uu____16361 =
                 match (w1, w2) with
                 | (FStar_Pervasives_Native.Some
                 ...
                 | uu____16403 -> false  in
               check "branch when" uu____16361)
      ...
      fun lb2  ->
        ((let uu____16424 =
            eqsum (fun bv1  -> fun bv2  -> true) FStar_Syntax_Syntax.fv_eq
             ...
             in
          check "lb bv" uu____16424) &&
           (let uu____16433 =
              term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp
                lb2.FStar_Syntax_Syntax.lbtyp
               in
            check "lb typ" uu____16433))
          &&
          (let uu____16437 =
             term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef
               lb2.FStar_Syntax_Syntax.lbdef
              in
           check "lb def" uu____16437)
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let r =
        let uu____16454 = FStar_ST.op_Bang debug_term_eq  in
        term_eq_dbg uu____16454 t1 t2  in
...
let rec (sizeof : FStar_Syntax_Syntax.term -> Prims.int) =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____16508 ->
        let uu____16523 =
          let uu____16525 = FStar_Syntax_Subst.compress t  in
          sizeof uu____16525  in
        Prims.int_one + uu____16523
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____16528 = sizeof bv.FStar_Syntax_Syntax.sort  in
        Prims.int_one + uu____16528
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____16532 = sizeof bv.FStar_Syntax_Syntax.sort  in
        Prims.int_one + uu____16532
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____16541 = sizeof t1  in (FStar_List.length us) + uu____16541
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____16545) ->
        let uu____16570 = sizeof t1  in
        let uu____16572 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16587  ->
                 ...
                 | (bv,uu____16597) ->
                     ...
                     acc + uu____16602) Prims.int_zero bs
           in
        uu____16570 + uu____16572
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____16631 = sizeof hd1  in
        let uu____16633 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16648  ->
                 ...
                 | (arg,uu____16658) ->
                     let uu____16663 = sizeof arg  in acc + uu____16663)
            Prims.int_zero args
           in
        uu____16631 + uu____16633
    | uu____16666 -> Prims.int_one
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____16680 =
        let uu____16681 = un_uinst t  in uu____16681.FStar_Syntax_Syntax.n
         in
...
let (get_attribute :
  ...
  fun attr  ->
    fun attrs  ->
      FStar_List.tryPick
        (fun t  ->
           let uu____16747 = head_and_args t  in
           match uu____16747 with
           | (head1,args) ->
               let uu____16802 =
                 let uu____16803 = FStar_Syntax_Subst.compress head1  in
                 uu____16803.FStar_Syntax_Syntax.n  in
               (match uu____16802 with
                | FStar_Syntax_Syntax.Tm_fvar fv when
                    FStar_Syntax_Syntax.fv_eq_lid fv attr ->
                    FStar_Pervasives_Native.Some args
                | uu____16829 -> FStar_Pervasives_Native.None)) attrs
...
let (remove_attr :
  ...
  fun attr  ->
    fun attrs  ->
      FStar_List.filter
        (fun a  ->
           let uu____16862 = is_fvar attr a  in Prims.op_Negation uu____16862)
        attrs
...
let rec (unbound_variables :
  ...
  fun tm  ->
    ...
    | FStar_Syntax_Syntax.Tm_uvar uu____16963 -> []
    | FStar_Syntax_Syntax.Tm_type u -> []
    | FStar_Syntax_Syntax.Tm_bvar x -> [x]
    | FStar_Syntax_Syntax.Tm_fvar uu____16978 -> []
    | FStar_Syntax_Syntax.Tm_constant uu____16979 -> []
    | FStar_Syntax_Syntax.Tm_lazy uu____16980 -> []
    | FStar_Syntax_Syntax.Tm_unknown  -> []
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) -> unbound_variables t1
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____16989) ->
        let uu____17014 = FStar_Syntax_Subst.open_term bs t1  in
         ...
         | (bs1,t2) ->
             let uu____17023 =
               FStar_List.collect
                ...
                in
             let uu____17050 = unbound_variables t2  in
             FStar_List.append uu____17023 uu____17050)
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
               ...
               FStar_List.collect
                 (fun uu____17096  ->
                    ...
                    | (b,uu____17106) ->
                        unbound_variables b.FStar_Syntax_Syntax.sort) bs1
                in
             let uu____17111 = unbound_variables_comp c1  in
         ...
         | (bs,t2) ->
             let uu____17143 =
               FStar_List.collect
                ...
                in
             let uu____17170 = unbound_variables t2  in
             FStar_List.append uu____17143 uu____17170)
    | FStar_Syntax_Syntax.Tm_app (t1,args) ->
        let uu____17199 =
          FStar_List.collect
            (fun uu____17213  ->
               match uu____17213 with
               | (x,uu____17225) -> unbound_variables x) args
           in
        let uu____17234 = unbound_variables t1  in
        FStar_List.append uu____17199 uu____17234
    | FStar_Syntax_Syntax.Tm_match (t1,pats) ->
        ...
        let uu____17278 =
          FStar_All.pipe_right pats
            (FStar_List.collect
               (fun br  ->
                  let uu____17293 = FStar_Syntax_Subst.open_branch br  in
                  match uu____17293 with
                  | (p,wopt,t2) ->
                      let uu____17315 = unbound_variables t2  in
                      let uu____17318 =
                        match wopt with
                        | FStar_Pervasives_Native.None  -> []
                        | FStar_Pervasives_Native.Some t3 ->
                         ...
                         in
                      FStar_List.append uu____17315 uu____17318))
           in
        FStar_List.append uu____17275 uu____17278
    | FStar_Syntax_Syntax.Tm_ascribed (t1,asc,uu____17332) ->
        let uu____17373 = unbound_variables t1  in
        let uu____17376 =
          let uu____17379 =
          ...
          FStar_List.append uu____17379 uu____17410  in
        FStar_List.append uu____17373 uu____17376
    | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t1) ->
        let uu____17451 = unbound_variables lb.FStar_Syntax_Syntax.lbtyp  in
        let uu____17454 =
          let uu____17457 = unbound_variables lb.FStar_Syntax_Syntax.lbdef
             in
          let uu____17460 =
            match lb.FStar_Syntax_Syntax.lbname with
            | FStar_Util.Inr uu____17465 -> unbound_variables t1
            | FStar_Util.Inl bv ->
                let uu____17467 =
                ...
                (match uu____17467 with
                 | (uu____17488,t2) -> unbound_variables t2)
             in
          FStar_List.append uu____17457 uu____17460  in
        FStar_List.append uu____17451 uu____17454
    | FStar_Syntax_Syntax.Tm_let ((uu____17490,lbs),t1) ->
        let uu____17510 = FStar_Syntax_Subst.open_let_rec lbs t1  in
        (match uu____17510 with
         | (lbs1,t2) ->
             let uu____17525 = unbound_variables t2  in
             let uu____17528 =
               FStar_List.collect
                 (fun lb  ->
                    let uu____17535 =
                    ...
                    FStar_List.append uu____17535 uu____17538) lbs1
                in
    ...
    | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
        let uu____17555 = unbound_variables t1  in
        let uu____17558 =
          match m with
          | FStar_Syntax_Syntax.Meta_pattern (uu____17563,args) ->
              FStar_List.collect
                (FStar_List.collect
                   (fun uu____17618  ->
                      match uu____17618 with
                      | (a,uu____17630) -> unbound_variables a)) args
          | FStar_Syntax_Syntax.Meta_monadic_lift
              (uu____17639,uu____17640,t') -> unbound_variables t'
          | FStar_Syntax_Syntax.Meta_monadic (uu____17646,t') ->
              unbound_variables t'
          | FStar_Syntax_Syntax.Meta_labeled uu____17652 -> []
          | FStar_Syntax_Syntax.Meta_desugared uu____17661 -> []
          | FStar_Syntax_Syntax.Meta_named uu____17662 -> []  in
        FStar_List.append uu____17555 uu____17558
...
and (unbound_variables_comp :
  ...
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.GTotal (t,uu____17669) -> unbound_variables t
    | FStar_Syntax_Syntax.Total (t,uu____17679) -> unbound_variables t
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17689 = unbound_variables ct.FStar_Syntax_Syntax.result_typ
           in
        let uu____17692 =
          FStar_List.collect
            (fun uu____17706  ->
               match uu____17706 with
               | (a,uu____17718) -> unbound_variables a)
            ct.FStar_Syntax_Syntax.effect_args
           in
        FStar_List.append uu____17689 uu____17692
  ...
  fun attr_lid  ->
    fun attrs  ->
      let rec aux acc attrs1 =
        ...
        | [] -> FStar_Pervasives_Native.None
        | h::t ->
            let uu____17833 = head_and_args h  in
            (match uu____17833 with
             | (head1,args) ->
                 let uu____17894 =
                   let uu____17895 = FStar_Syntax_Subst.compress head1  in
                   uu____17895.FStar_Syntax_Syntax.n  in
                 (match uu____17894 with
                  | FStar_Syntax_Syntax.Tm_fvar fv when
                      FStar_Syntax_Syntax.fv_eq_lid fv attr_lid ->
                      let attrs' = FStar_List.rev_acc acc t  in
                      FStar_Pervasives_Native.Some (attrs', args)
                  | uu____17948 -> aux (h :: acc) t))
         in
      aux [] attrs
  ...
  fun attr_lid  ->
    fun se  ->
      ...
      | FStar_Pervasives_Native.Some (attrs',t) ->
          FStar_Pervasives_Native.Some
            ((let uu___2484_18014 = se  in
              {
                FStar_Syntax_Syntax.sigel =
                  (uu___2484_18014.FStar_Syntax_Syntax.sigel);
                FStar_Syntax_Syntax.sigrng =
                  (uu___2484_18014.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals =
                  (uu___2484_18014.FStar_Syntax_Syntax.sigquals);
                FStar_Syntax_Syntax.sigmeta =
                  (uu___2484_18014.FStar_Syntax_Syntax.sigmeta);
                FStar_Syntax_Syntax.sigattrs = attrs';
                FStar_Syntax_Syntax.sigopts =
                  (uu___2484_18014.FStar_Syntax_Syntax.sigopts)
              }), t)
  
let (is_smt_lemma : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____18022 =
      let uu____18023 = FStar_Syntax_Subst.compress t  in
      uu____18023.FStar_Syntax_Syntax.n  in
    match uu____18022 with
    | FStar_Syntax_Syntax.Tm_arrow (uu____18027,c) ->
        (match c.FStar_Syntax_Syntax.n with
         | FStar_Syntax_Syntax.Comp ct when
             ...
             (match ct.FStar_Syntax_Syntax.effect_args with
              | _req::_ens::(pats,uu____18055)::uu____18056 ->
                  let pats' = unmeta pats  in
                  let uu____18116 = head_and_args pats'  in
                  (match uu____18116 with
                   | (head1,uu____18135) ->
                       let uu____18160 =
                         let uu____18161 = un_uinst head1  in
...
let rec (list_elements :
  ...
  fun e  ->
    let uu____18198 =
      let uu____18215 = unmeta e  in head_and_args uu____18215  in
    match uu____18198 with
    | (head1,args) ->
        let uu____18246 =
          let uu____18261 =
            let uu____18262 = un_uinst head1  in
            uu____18262.FStar_Syntax_Syntax.n  in
          (uu____18261, args)  in
        (match uu____18246 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____18280) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____18304::(hd1,uu____18306)::(tl1,uu____18308)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____18375 =
               let uu____18378 =
                 let uu____18381 = list_elements tl1  in
                 FStar_Util.must uu____18381  in
               hd1 :: uu____18378  in
             FStar_Pervasives_Native.Some uu____18375
         | uu____18390 -> FStar_Pervasives_Native.None)
...
let (unthunk_lemma_post :
  ...
  fun t  ->
    let uu____18419 =
      let uu____18420 = FStar_Syntax_Subst.compress t  in
      uu____18420.FStar_Syntax_Syntax.n  in
    match uu____18419 with
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____18427) ->
        let uu____18462 = FStar_Syntax_Subst.open_term [b] e  in
        (match uu____18462 with
         | (bs,e1) ->
             let b1 = FStar_List.hd bs  in
             let uu____18496 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____18496
             then
               let uu____18503 =
                 let uu____18514 = FStar_Syntax_Syntax.as_arg exp_unit  in
                 [uu____18514]  in
               mk_app t uu____18503
             else e1)
    | uu____18541 ->
        let uu____18542 =
          let uu____18553 = FStar_Syntax_Syntax.as_arg exp_unit  in
          [uu____18553]  in
        mk_app t uu____18542
  ...
  fun t  ->
    fun universe_of_binders  ->
      let list_elements1 e =
        let uu____18608 = list_elements e  in
      ...
      let one_pat p =
        let uu____18643 =
          let uu____18660 = unmeta p  in
          FStar_All.pipe_right uu____18660 head_and_args  in
        match uu____18643 with
        | (head1,args) ->
            let uu____18711 =
              let uu____18726 =
                let uu____18727 = un_uinst head1  in
                uu____18727.FStar_Syntax_Syntax.n  in
              (uu____18726, args)  in
            (match uu____18711 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18749,uu____18750)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____18817 =
                   let uu____18823 =
                     ...
                     FStar_Util.format1
                       ...
                       uu____18825
                      in
                   (FStar_Errors.Error_IllSMTPat, uu____18823)  in
      ...
      let lemma_pats p =
        ...
        let smt_pat_or t1 =
          let uu____18868 =
            let uu____18885 = unmeta t1  in
            FStar_All.pipe_right uu____18885 head_and_args  in
          match uu____18868 with
          | (head1,args) ->
              let uu____18932 =
                let uu____18947 =
                  let uu____18948 = un_uinst head1  in
                  uu____18948.FStar_Syntax_Syntax.n  in
                (uu____18947, args)  in
              (match uu____18932 with
               | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____18967)::[]) when
                   FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        match elts with
        | t1::[] ->
            let uu____19034 = smt_pat_or t1  in
            (match uu____19034 with
             | FStar_Pervasives_Native.Some e ->
                 let uu____19056 = list_elements1 e  in
                 FStar_All.pipe_right uu____19056
                   (FStar_List.map
                      (fun branch1  ->
                         let uu____19086 = list_elements1 branch1  in
                         FStar_All.pipe_right uu____19086
      ...
      let uu____19233 =
        let uu____19266 =
          let uu____19267 = FStar_Syntax_Subst.compress t  in
          uu____19267.FStar_Syntax_Syntax.n  in
        match uu____19266 with
        | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
            let uu____19324 = FStar_Syntax_Subst.open_comp binders c  in
            (match uu____19324 with
             | (binders1,c1) ->
                 (match c1.FStar_Syntax_Syntax.n with
                  ...
                  | uu____19502 -> failwith "impos"))
        | uu____19536 -> failwith "Impos"  in
      ...
      | (binders,pre,post,patterns) ->
          ...
          let body =
            let uu____19628 =
              let uu____19635 =
                let uu____19636 =
                  let uu____19643 = mk_imp pre post1  in
                  let uu____19646 =
                    let uu____19647 =
                      let uu____19668 =
                        FStar_Syntax_Syntax.binders_to_names binders  in
                      (uu____19668, patterns)  in
                    FStar_Syntax_Syntax.Meta_pattern uu____19647  in
                  (uu____19643, uu____19646)  in
                FStar_Syntax_Syntax.Tm_meta uu____19636  in
              FStar_Syntax_Syntax.mk uu____19635  in
            uu____19628 FStar_Pervasives_Native.None
              t.FStar_Syntax_Syntax.pos
             in
          let quant =
            let uu____19692 = universe_of_binders binders  in
            FStar_List.fold_right2
              (fun b  ->
                 fun u  ->
                   fun out  ->
...
let (eff_decl_of_new_effect :
  ...
  fun se  ->
    ...
    | uu____19722 -> failwith "eff_decl_of_new_effect: not a Sig_new_effect"
  
let (is_layered : FStar_Syntax_Syntax.eff_decl -> Prims.bool) =
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.Layered_eff uu____19733 -> true
    | uu____19735 -> false
  
let (is_dm4f : FStar_Syntax_Syntax.eff_decl -> Prims.bool) =
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.DM4F_eff uu____19746 -> true
    | uu____19748 -> false
...
let (apply_wp_eff_combinators :
  ...
  fun f  ->
    fun combs  ->
      let uu____19766 = f combs.FStar_Syntax_Syntax.ret_wp  in
      let uu____19767 = f combs.FStar_Syntax_Syntax.bind_wp  in
      let uu____19768 = f combs.FStar_Syntax_Syntax.stronger  in
      let uu____19769 = f combs.FStar_Syntax_Syntax.if_then_else  in
      let uu____19770 = f combs.FStar_Syntax_Syntax.ite_wp  in
      let uu____19771 = f combs.FStar_Syntax_Syntax.close_wp  in
      let uu____19772 = f combs.FStar_Syntax_Syntax.trivial  in
      let uu____19773 =
      ...
      {
        FStar_Syntax_Syntax.ret_wp = uu____19766;
        FStar_Syntax_Syntax.bind_wp = uu____19767;
        FStar_Syntax_Syntax.stronger = uu____19768;
        FStar_Syntax_Syntax.if_then_else = uu____19769;
        FStar_Syntax_Syntax.ite_wp = uu____19770;
        FStar_Syntax_Syntax.close_wp = uu____19771;
        FStar_Syntax_Syntax.trivial = uu____19772;
        FStar_Syntax_Syntax.repr = uu____19773;
        FStar_Syntax_Syntax.return_repr = uu____19776;
        FStar_Syntax_Syntax.bind_repr = uu____19779
      }
...
let (apply_layered_eff_combinators :
  ...
  fun f  ->
    fun combs  ->
      let map_tuple uu____19811 =
        match uu____19811 with
        | (ts1,ts2) ->
            let uu____19822 = f ts1  in
            let uu____19823 = f ts2  in (uu____19822, uu____19823)
         in
      let uu____19824 = map_tuple combs.FStar_Syntax_Syntax.l_repr  in
      let uu____19829 = map_tuple combs.FStar_Syntax_Syntax.l_return  in
      let uu____19834 = map_tuple combs.FStar_Syntax_Syntax.l_bind  in
      let uu____19839 = map_tuple combs.FStar_Syntax_Syntax.l_subcomp  in
      let uu____19844 = map_tuple combs.FStar_Syntax_Syntax.l_if_then_else
         in
      {
        FStar_Syntax_Syntax.l_base_effect =
          (combs.FStar_Syntax_Syntax.l_base_effect);
        FStar_Syntax_Syntax.l_repr = uu____19824;
        FStar_Syntax_Syntax.l_return = uu____19829;
        FStar_Syntax_Syntax.l_bind = uu____19834;
        FStar_Syntax_Syntax.l_subcomp = uu____19839;
        FStar_Syntax_Syntax.l_if_then_else = uu____19844
      }
  ...
  fun f  ->
    fun combs  ->
      ...
      | FStar_Syntax_Syntax.Primitive_eff combs1 ->
          let uu____19866 = apply_wp_eff_combinators f combs1  in
          FStar_Syntax_Syntax.Primitive_eff uu____19866
      | FStar_Syntax_Syntax.DM4F_eff combs1 ->
          let uu____19868 = apply_wp_eff_combinators f combs1  in
          FStar_Syntax_Syntax.DM4F_eff uu____19868
      | FStar_Syntax_Syntax.Layered_eff combs1 ->
          let uu____19870 = apply_layered_eff_combinators f combs1  in
          FStar_Syntax_Syntax.Layered_eff uu____19870
...
let (get_wp_close_combinator :
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.DM4F_eff combs ->
        FStar_Pervasives_Native.Some (combs.FStar_Syntax_Syntax.close_wp)
    | uu____19885 -> FStar_Pervasives_Native.None
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        ...
        FStar_All.pipe_right uu____19899
          (fun _19906  -> FStar_Pervasives_Native.Some _19906)
...
let (get_wp_trivial_combinator :
  ...
  fun ed  ->
    ...
    | uu____19993 -> FStar_Pervasives_Native.None
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        let uu____20005 =
          FStar_All.pipe_right combs.FStar_Syntax_Syntax.l_if_then_else
            FStar_Pervasives_Native.fst
           in
        FStar_All.pipe_right uu____20005
          (fun _20012  -> FStar_Pervasives_Native.Some _20012)
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Primitive_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.if_then_else
          (fun _20027  -> FStar_Pervasives_Native.Some _20027)
    | FStar_Syntax_Syntax.DM4F_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.if_then_else
...
let (get_stronger_repr :
  ...
  fun ed  ->
    match ed.FStar_Syntax_Syntax.combinators with
    | FStar_Syntax_Syntax.Primitive_eff uu____20075 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.DM4F_eff uu____20076 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Layered_eff combs ->
        let uu____20078 =
          FStar_All.pipe_right combs.FStar_Syntax_Syntax.l_subcomp
        ...
        FStar_All.pipe_right uu____20078
          (fun _20085  -> FStar_Pervasives_Native.Some _20085)
  ...
  fun ed  ->
    ...
    | FStar_Syntax_Syntax.Layered_eff combs ->
        FStar_All.pipe_right combs.FStar_Syntax_Syntax.l_base_effect
          (fun _20099  -> FStar_Pervasives_Native.Some _20099)
