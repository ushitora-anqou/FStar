                                     ...
                                     (let g1 =
                                           ...
                                           in
                                        {
                                          ...
                                          FStar_TypeChecker_Common.deferred_to_tac
                                            =
                                            (uu___221_2588.FStar_TypeChecker_Common.deferred_to_tac);
                    ...
                    | FStar_Pervasives_Native.Some vc ->
                        ((let uu____5519 = FStar_ST.op_Bang tacdbg  in
                         ...
                         (let guard =
                          ...
                          let uu____5563 = FStar_Tactics_Types.goal_env g  in
                          FStar_TypeChecker_Rel.force_trivial_guard
                            uu____5563 guard))
                    | FStar_Pervasives_Native.None  ->
                        let uu____5564 = FStar_TypeChecker_Env.get_range env
                           in
                        FStar_Errors.raise_error
                          (FStar_Errors.Fatal_OpenGoalsInSynthesis,
                            "synthesis left open goals") uu____5564))))
              ...
              ((let uu____5641 =
                  FStar_List.existsML
                    (fun g  ->
                       let uu____5646 =
                         let uu____5648 =
                           let uu____5651 = FStar_Tactics_Types.goal_env g
                              in
                           let uu____5652 = FStar_Tactics_Types.goal_type g
                              in
                           getprop uu____5651 uu____5652  in
                         FStar_Option.isSome uu____5648  in
                       Prims.op_Negation uu____5646) gs
                   in
                if uu____5641
                then
                  FStar_Errors.raise_error
               ...
               (let uu____5659 = FStar_ST.op_Bang tacdbg  in
                if uu____5659
                then
                  let uu____5683 =
                    FStar_Common.string_of_list
           ...
           (let ps =
            ...
            let uu____5733 =
              run_tactic_on_ps tau.FStar_Syntax_Syntax.pos
               ...
               in
            match uu____5733 with | (gs,tm1) -> tm1))
          ...
          then tm
            ...
            ((let uu____5771 =
                FStar_TypeChecker_Env.debug env (FStar_Options.Other "Tac")
                 in
              FStar_ST.op_Colon_Equals tacdbg uu____5771);
             (let uu____5795 =
              ...
              | (uvtm,uu____5810,g_imp) ->
                  let u = env.FStar_TypeChecker_Env.universe_of env typ  in
                  let goal =
                    let uu____5828 = FStar_Syntax_Util.mk_eq2 u typ tm uvtm
                       in
                    FStar_Syntax_Util.mk_squash u uu____5828  in
                  let uu____5829 =
                    run_tactic_on_typ tau.FStar_Syntax_Syntax.pos
                       ...
                       (FStar_List.iter
                          (fun g  ->
                             let uu____5850 =
                               ...
                               let uu____5854 =
                                 FStar_Tactics_Types.goal_type g  in
                               getprop uu____5853 uu____5854  in
                             match uu____5850 with
                             | FStar_Pervasives_Native.Some vc ->
                                 ((let uu____5857 = FStar_ST.op_Bang tacdbg
                                      in
                                   if uu____5857
                                   then
                                     let uu____5881 =
